...
Please refer to the section below for repository-based specifics.
...
- The only other exception to the above is when writing/reading a value from the `cache` global, or when using one of its builtin functions.
