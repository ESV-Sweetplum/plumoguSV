...
function penisSettingsMenu(settingVars)
    ...
    _, settingVars.sCurvature =
        imgui.SliderInt('S Curvature', settingVars.sCurvature, 1, 100, settingVars.sCurvature .. '%%')
    _, settingVars.bCurvature =
        imgui.SliderInt('B Curvature', settingVars.bCurvature, 1, 100, settingVars.bCurvature .. '%%')
end
