function linearVibratoMenu(menuVars, settingVars, separateWindow)
    if menuVars.vibratoMode == 1 then
        ...
        local func = function(t) return settingVars.endMsx * t + settingVars.startMsx * (1 - t) end
        ...
        local func1 = function(t) return settingVars.lowerStart + t * (settingVars.lowerEnd - settingVars.lowerStart) end
        local func2 = function(t) return settingVars.higherStart + t * (settingVars.higherEnd - settingVars.higherStart) end
