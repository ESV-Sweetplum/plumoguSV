function showHotkeyTutorial()
    ...
    imgui.BulletText(
        'If you have a vibrato window, press "'
            .. globalVars.hotkeyList[hotkeys_enum.exec_vibrato]
            .. '" to quickly place vibrato.'
    )
    imgui.BulletText(
        'Press "' .. globalVars.hotkeyList[hotkeys_enum.swap_primary] .. '" to quickly swap any swappable parameters.'
    )
    imgui.BulletText(
        'Press "'
            .. globalVars.hotkeyList[hotkeys_enum.negate_primary]
            .. '" to quickly negatable any negatable parameters.'
    )
    imgui.BulletText(
        'Press "'
    ...
    imgui.BulletText(
        'Press "' .. globalVars.hotkeyList[hotkeys_enum.go_to_next_tg] .. '" to go to the next timing group.'
    )
    imgui.BulletText(
        'Press "'
