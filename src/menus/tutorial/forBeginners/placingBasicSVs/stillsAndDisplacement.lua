function showStillsAndDisplacementTutorial()
    ...
    gpsim(
        'StillsAndDisplacementNaiveApproach',
        vctr2(1),
        function(t, idx) return t ^ 2 - (4 - idx) ^ 2 / 30 end,
        { { 3, 4 }, { 2 }, { 3 }, { 1 } },
        500
    )
    ...
    imgui.TextColored(INSTRUCTION_COLOR, 'Select "STILL" under the "TYPE" dropdown.')
    ...
    gpsim(
        'StillsAndDisplacementGoodApproach',
        vctr2(1),
        function(t) return t ^ 2 end,
        { { 3, 4 }, { 2 }, { 3 }, { 1 } },
        500
    )
    imgui.TextWrapped(
