...
function drawV200(ctx, location, scale, thickness)
    ...
    local colFn = function(x) return color.vrgbaToUint(color.hslaToRgba(x + hueDegreeAdjust, 1, 0.7, 1)) end
    ...
    ctx.AddBezierCubic(
        location + scale * vector.New(130.82, 48.93),
    ...
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(128.173, 11.58),
        location + scale * vector.New(130.82, 11.58),
        colFn(130.82),
        thickness
    )
    ctx.AddBezierCubic(
    ...
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(140.97, 17.393),
        location + scale * vector.New(141.97, 20.18),
        colFn(141.97),
        thickness
    )
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(143.47, 26.327),
        location + scale * vector.New(143.47, 30.26),
        colFn(143.47),
        thickness
    )
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(142.97, 37.583),
        location + scale * vector.New(141.97, 40.37),
        colFn(141.97),
        thickness
    )
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(139.54, 45.28),
        location + scale * vector.New(137.66, 46.74),
        colFn(137.66),
        thickness
    )
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(133.5, 48.93),
        location + scale * vector.New(130.82, 48.93),
        colFn(130.82),
        thickness
    )
    ctx.AddBezierCubic(
        location + scale * vector.New(130.82, 45.03),
        location + scale * vector.New(133.473, 45.03),
        location + scale * vector.New(135.533, 43.75),
        location + scale * vector.New(137, 41.19),
        colFn(137),
        thickness
    )
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(139.2, 34.993),
        location + scale * vector.New(139.2, 30.26),
        colFn(139.2),
        thickness
    )
    ctx.AddBezierCubic(
    ...
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(136.573, 18.31),
        location + scale * vector.New(135.32, 17.15),
        colFn(135.32),
        thickness
    )
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(132.573, 15.41),
        location + scale * vector.New(130.82, 15.41),
        colFn(130.82),
        thickness
    )
    ctx.AddBezierCubic(
    ...
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(122.44, 25.533),
        location + scale * vector.New(122.44, 30.26),
        colFn(122.44),
        thickness
    )
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(122.773, 36.08),
        location + scale * vector.New(123.44, 38.28),
        colFn(123.44),
        thickness
    )
    ctx.AddBezierCubic(
        location + scale * vector.New(123.44, 38.28),
        location + scale * vector.New(124.1, 40.48),
    ...
    ctx.AddBezierCubic(
        ...
        location + scale * vector.New(129.06, 45.03),
        location + scale * vector.New(130.82, 45.03),
        colFn(130.82),
        thickness
    )
