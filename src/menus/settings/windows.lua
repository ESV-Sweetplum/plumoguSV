function showWindowSettings()
    ...
    GlobalCheckbox(
        'showNoteDataWidget',
        'Show Note Data Of Selection',
        'If one note is selected, shows simple data about that note.'
    )
    GlobalCheckbox(
        'showMeasureDataWidget',
        'Show Measure Data Of Selection',
