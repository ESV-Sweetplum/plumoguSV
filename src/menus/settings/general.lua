function showGeneralSettings()
    ...
    GlobalCheckbox(
        'simultaneousDeleteModes',
        'Enable Simultaneous Delete Modes',
    ...
    GlobalCheckbox(
        ...
        'Print Legacy LN Recommendation',
...
function chooseUpscroll()
    ...
    globalVars.upscroll = RadioButtons(
        'Scroll Direction:',
        globalVars.upscroll,
        { 'Down', 'Up' },
        { false, true },
    ...
    if oldUpscroll ~= globalVars.upscroll then write(globalVars) end
end
