...
function coordsRelativeToWindow(x, y) return vector.New(x, y) + imgui.GetWindowPos() end
...
function relativePoint(point, xChange, yChange) return point + vector.New(xChange, yChange) end
