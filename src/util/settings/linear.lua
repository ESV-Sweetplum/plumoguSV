function linearSettingsMenu(settingVars, skipFinalSV, svPointsForce)
    ...
    if globalVars.advancedMode then settingsChanged = chooseLinearDistanceMode(settingVars) or settingsChanged end
    if settingVars.distanceMode == 1 then settingsChanged = chooseStartEndSVs(settingVars) or settingsChanged end
