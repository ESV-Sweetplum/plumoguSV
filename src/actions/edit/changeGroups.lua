function changeGroups(menuVars)
    ...
    if willChangeSVs then
        ...
        state.SelectedScrollGroupId = menuVars.designatedTimingGroup -- must change in the middle because previous line applies to previous tg, next line applies to next tg
